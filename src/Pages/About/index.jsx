    ...
    return (
        <div className='about-page-container'>
            ...
            <section className='group-description'>
                ...
                <p className='description'> Feito utilizando o React para o Frontend e o axios para consumir a API do Github.</p>
                <p className='description'>Desenvolvido por Alberto José, estudante de Ciência da Computação na UFRPE.</p>
